...
$('.wWhitePGnumber').click(function () {
    $(this).css('backgroundColor', '#01FFC3').siblings().css('backgroundColor', '#FFFFFF');
    newPg1 = $(this).text();
...
$('.wWhiteJPPG').click(function () {
    ...
    $('.wWhitePGnumber').eq(newPg3).css('backgroundColor', '#01FFC3').siblings().css('backgroundColor', '#FFFFFF');
})
