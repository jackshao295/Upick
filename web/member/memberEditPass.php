                ...
                <div class="memEditPassArea_HC">
                    <form action="">
                        <div class="memColumnWhite_HC memOldPassword_HC">
                            <!-- 舊密碼 -->
                            <p>舊密碼</p>
                            <input id="memOldPassword_HC" type="password" placeholder="請輸入舊密碼" name="password" class="memPassWord_HC">
                            <i toggle="#memOldPassword_HC" class="far fa-eye-slash memPassIcon_HC memToggleOldPassword_HC"></i>
                        </div>
                        <div class="memColumnWhite_HC memNewPassword_HC">
                            <!-- 新密碼 -->
                            <p>新密碼</p>
                            <input onkeyup="checkPass()" id="memNewPassword_HC" type="password" placeholder="請輸入新密碼" name="password" class="memCheckPswrd1_HC memPassWord_HC">
                            <i toggle="#memNewPassword_HC" class="far fa-eye-slash memPassIcon_HC memToggleNewPassword_HC"></i>
                        </div>
                        <div class="memColumnWhite_HC memCheckPassword_HC">
                            <!-- 確認新密碼 -->
                            <p>確認新密碼</p>
                            <input onkeyup="checkPass()" id="memCheckPassword_HC" type="password" placeholder="請再次輸入新密碼" name="password" class="memCheckPswrd2_HC">
                            <i toggle="#memCheckPassword_HC" class="far fa-eye-slash memPassIcon_HC memToggleCheckPassword_HC"></i>
                        </div>
